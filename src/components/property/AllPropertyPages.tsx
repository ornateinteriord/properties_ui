  ...
  const filteredProperties = Array.isArray(properties)
    ? properties.filter((property: any) => {
        ...
        const matchesSubtype =
          selectedSubtype === "all" || property.subtype || property.bhk === selectedSubtype;
        ...
        const matchesBudget =
          ...
          (() => {
            ...
            const propertyBudget = parseFloat(
              property.budget.replace(/[^0-9.]/g, "")
            );
        ...
        return (
          matchesType && matchesSubtype && matchesBudget && matchesSquareFeet
        );
      })
    : [];
